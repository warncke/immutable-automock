...
if (!immutableAutomock.moduleCallMocks) {
    immutableAutomock.moduleCallMocks = {}
}
// global store of module call resolve mocks keyed by moduleCallId
if (!immutableAutomock.moduleCallResolveMocks) {
    immutableAutomock.moduleCallResolveMocks = {}
}
...
function loadMockModuleCall (mockData, options) {
    ...
    immutableAutomock.moduleCallMocks[stableId] = mockData.data
}
...
function loadMockModuleCallResolve (mockData, options) {
    ...
    immutableAutomock.moduleCallResolveMocks[mockData.data.moduleCallId] = mockData.data
}
