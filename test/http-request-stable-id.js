...
describe('immutable-automock: http request stable id', function () {
    ...
    it('should generate different id for requests with same options and different requestId', function () {
        var httpRequestData1 = {
            options: {
                foo: true,
            },
    ...
    it('should generate different id for requests with same options and different moduleCallId', function () {
        var httpRequestData1 = {
            options: {
                foo: true,
            },
    ...
    it('should generate different id for requests with different options', function () {
        var httpRequestData1 = {
            options: {
                foo: true,
            },
